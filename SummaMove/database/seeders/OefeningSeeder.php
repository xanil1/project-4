...
class OefeningSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Oefening::Create([
            ...
            'image' => 'public/images/Push-up.png'
        ]);
        Oefening::Create([
            'name' => 'Dip',
